...
The project 'Emotion Recognition in Video' has been done as a final project of Applied Science - Deep Learning Workshop
(with Dr. Oren Elisha and Oded Ovadia).

This README file is here in order to prevent any confusions regarding the content of the .zip folder in the submission of this project,
and to make sure it is run appropriately.
...
3. A folder named "outputs" containing .mp4 videos produced in the making of the project-
 As you will see, there are commented parts in the notebook. Running some of those made some runtime issues and RAM crashes,
 and in order to prevent those when reviewing the project, we decided to run them "offline" and provide them in the folder.
...
The "base_path" variable should be changed to the name of this directory.
